...
#!/usr/bin/env python3
"""
LightGBM Model for Planned Giving Prediction
...
plt.title('LightGBM - PG Capture Rate', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('lightgbm_capture_rate.png', dpi=300, bbox_inches='tight')
print("\n✓ Saved: lightgbm_capture_rate.png")
plt.show()
